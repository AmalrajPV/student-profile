import { faCheckCircle, faEye, faPen, faShareFromSquare } from "@fortawesome/free-solid-svg-icons";
...
export const UlBox = (props) => {
    return ( 
        <div className="right-box-inner">
            <div className="rbi-title">{props.icon} {props.title}</div>
...
export const ProfileBox = (props)=>{
    return(
        <div className="box">
          ...
          {props.logged ? <div className="l-btns">
